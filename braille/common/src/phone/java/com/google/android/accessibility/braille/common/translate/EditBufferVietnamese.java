...
/** An EditBuffer for Vietnamese Braille Grade 0. */
public class EditBufferVietnamese extends EditBufferCommon {
  ...
  protected Optional<String> getAppendBrailleTextToSpeak(
    ...
    if (brailleCharacter.equals(BrailleTranslateUtilsVietnamese.CAPITALIZE)) {
